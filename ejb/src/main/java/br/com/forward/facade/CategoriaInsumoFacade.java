...
public class CategoriaInsumoFacade implements CategoriaInsumoFacadeLocal {
	...
	public List<CategoriaInsumoVO> carregarCategoriaInsumos(CategoriaInsumoVO categoriaInsumoVO) {
		LOGGER.info("CategoriaInsumoBusiness.carregarCategoriaInsumo(CategoriaInsumoVO) [INICIO] parametro=" + categoriaInsumoVO);

		final List<CategoriaInsumoVO> carregarCategoriaInsumo = this.categoriaInsumoBusiness
	...
	public List<CategoriaInsumoVO> carregarCategoriaInsumos() {
		...
		final List<CategoriaInsumoVO> carregarCategoriaInsumo = this.categoriaInsumoBusiness.carregarCategoriaInsumo();
